...
/**
 * The queryToTransformAll is a convenience function that combines the query and transform operations.
 * The transform used to configure the documents must be installed on the server beforehand.
...
/*
the batchSize defaults to the number recommended by Performance Engineering for remove operations (possibly 250).
the transformStrategy and transform properties are not supported.
*/
